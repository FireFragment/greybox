...
<div class="content-wrapper">
    ...
    <?php
        if ($page == "24-f-rozhodci" or $page == "24-f-jednotlivec" or $page == "24-f-dozor" or $page == "24-f-kouc") {
            if (!isset($_SESSION["token"])) {
                echo "<script> window.location.replace('$home'); </script>";
            }
            switch ($page) {
