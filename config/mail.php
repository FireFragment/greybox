...
return [
    ...
    */
    ...
    'default' => env('MAIL_DEFAULT_MAILER', 'default'),
    ...
    */
    ...
    'mailers' => [
        ...
        'pds' => [
            'transport' => env('PDS_MAIL_DRIVER', 'smtp'),
            'url' => env('MAIL_URL'),
            'host' => env('PDS_MAIL_HOST', 'smtp.mailgun.org'),
            'port' => env('PDS_MAIL_PORT', 587),
            'encryption' => env('PDS_MAIL_ENCRYPTION', 'tls'),
            'username' => env('PDS_MAIL_USERNAME'),
            'password' => env('PDS_MAIL_PASSWORD'),
            'timeout' => null,
            'local_domain' => env('MAIL_EHLO_DOMAIN'),
        ],
